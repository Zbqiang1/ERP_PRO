      ...
      <el-row :gutter="16">
        <el-col :span="12">
          <el-form-item label="出库单号" prop="outNo">
            <el-input v-model="form.outNo" placeholder="自动生成" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="出库类型" prop="outType">
            <el-select v-model="form.outType" placeholder="请选择出库类型" class="w-full">
        ...
        <el-col :span="12">
          <el-form-item label="出库日期" prop="outDate">
            <el-date-picker v-model="form.outDate" type="date" placeholder="选择日期" value-format="YYYY-MM-DD" class="w-full" />
          </el-form-item>
        </el-col>
      </el-row>
...
const emptyItem = () => ({ materialId: null, locationId: null, quantity: 0, unitPrice: 0, batchNo: '' })
const form = reactive({ id: null, outNo: '', outType: '', warehouseId: null, outDate: '', remark: '', items: [emptyItem()] })
...
const resetForm = () => { Object.assign(form, { id: null, outNo: '', outType: '', warehouseId: null, outDate: '', remark: '', items: [emptyItem()] }) }
